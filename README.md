...
**2. Is B2C growth driven by rising household income?** Not on a matching schedule. Income growth was front-loaded (fastest 2020–2022, then decelerating); B2C growth was back-loaded (flat through 2021–2022, then accelerating in 2023–2024). Both metrics happen to average out to the same 6.6% CAGR, but over different windows (income: 2020–2024; B2C: 2021–2024) — that match is coincidental, not evidence of a link, and the shapes diverging is the actual signal: B2C increasingly grew on its own timeline rather than tracking income, a sign of genuine digital channel shift rather than a wealthier consumer base simply spending more. *([Notebook 02](./notebooks/02-income-vs-ecommerce-growth.ipynb))*
